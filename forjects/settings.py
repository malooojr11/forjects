"""
Django settings for forjects project.
...
WSGI_APPLICATION = 'forjects.wsgi.application'
...
DEBUG = True
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'forjects.onrender.com']
